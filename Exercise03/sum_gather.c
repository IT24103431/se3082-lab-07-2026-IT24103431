...
int main(int argc, char **argv) {
    ...
    /*
     * GATHER: collect local_sum from every process into all_sums on root,
     * in rank order. This replaces the manual Send/Recv loop entirely.
     * Gather only collects data, it does not add the values itself.
     */
